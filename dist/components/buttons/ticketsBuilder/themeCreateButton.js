...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const themeTitle = new ActionRowBuilder().addComponents(new TextInputBuilder()
            .setLabel("Название темы")
            .setCustomId("themeTitle")
            .setPlaceholder("Жалоба на юзера")
            .setRequired(true)
            .setStyle(TextInputStyle.Short));
        const themeDesc = new ActionRowBuilder().addComponents(new TextInputBuilder()
            .setLabel("Описание темы")
            .setCustomId("themeDesc")
            .setPlaceholder("Отправьте жалобу и ...")
            .setRequired(true)
            .setStyle(TextInputStyle.Paragraph));
        const themeId = new ActionRowBuilder().addComponents(new TextInputBuilder()
            .setLabel("ID темы")
            .setCustomId("themeId")
            .setPlaceholder("report")
            .setRequired(true)
            .setStyle(TextInputStyle.Short));
        const themePingedRoles = new ActionRowBuilder().addComponents(new TextInputBuilder()
