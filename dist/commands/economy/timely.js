...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const embed = new EmbedBuilder().setTitle(`Eжедневная плата пользователю ${interaction.user.displayName}`);
        ...
        const balance = await userModel.updateOne({ guild_id: interaction.guildId, user_id: interaction.user.id }, { balance: updatedTargetBalance });
        let description = "";
        if (balance) {
