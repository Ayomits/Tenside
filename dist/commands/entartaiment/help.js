"use strict";
const { CommandInteraction, EmbedBuilder, ComponentType, filter, PermissionFlagsBits, StringSelectMenuBuilder, StringSelectMenuOptionBuilder, ActionRowBuilder, } = require("discord.js");
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const descriptionembed = new EmbedBuilder()
            ...
            .setDescription("Здесь вы можете выбрать модуль комманд о которых вы можете узнать.")
            .setColor("#2F3136")
            .setImage(img);
        ...
        collector.on("collect", async (i) => {
            ...
            if (selection == `reaction`) {
                ...
                const data = JSON.parse(await fs.promises.readFile(configs + "/help.json"));
