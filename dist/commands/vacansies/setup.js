...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const select = new ActionRowBuilder().addComponents(new ChannelSelectMenuBuilder()
            .setCustomId("selectVacanciesChannel")
            .setPlaceholder("выберите канал с вакансиями")
            .setChannelTypes(ChannelType.GuildText));
        const select2 = new ActionRowBuilder().addComponents(new ChannelSelectMenuBuilder()
