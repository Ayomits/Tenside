import { TextInputBuilder, ModalBuilder, TextInputStyle, ActionRowBuilder, ButtonInteraction, ModalSubmitInteraction, TextInputComponent} from "discord.js";


export async function embedBuilderModal (interaction: ButtonInteraction, customId: string) {
  const modal = new ModalBuilder()
    ...
    const image: any = new ActionRowBuilder().addComponents(
      new TextInputBuilder()
...
export async function embedBuilderModalCallback (interaction: ModalSubmitInteraction, model: any) {
